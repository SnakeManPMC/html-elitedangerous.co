...
My name is CMDR Snake Man and this is a story of what happened after returning to Elite after about 8 months break. I wanted to split this story in specific pages according to activity type like exploration, mining, trading, hunting missing data and bounty hunting, but it would have been such a spaghetti mess to jump back and forth between pages that a single page with continuing story through all of it is the best option.
	...
	<h2>2019-09-08 Getting Started</h2>

<p>
2019-09-08T15:25:00Z
</p>

<p>
Brought out Logitech/Saitek X-56 Rhino HOTAS, plugged it in and started to upgrade elite dangerous <img src="images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
Started launcher but as expected, I needed to download and <a href="launcher.php">install newer launcher</a>. I did, then launched and had to log in and do the stupid email verification code dance once again.
</p>
...
<p>
Did the first navigation and the second navigation docking tutorials, muscle memory needs to be refreshed <img src="images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
I must say it felt magical to be back in elite sidewinder cockpit, elite is just a great space game. I can't wait to start doing something productive in the actual elite universe again after setting up <a href="edmc.php">EDMC</a> and making sure <a href="edsm.php">EDSM</a> flight logs get updated etc.
</p>

<p>
Right now I'm not sure what I want to do, I'd like to <a href="exploration.php">explore</a> but also <a href="improving-trading-data.php">hunt for the missing data (improving trading data)</a> for commodity markets. Unfortunately reason tells me that the hunt for missing data is the same old as it always was and I get frustrated/bored with it in day or two because <a href="https://www.edsm.net/en/systems/stations" target="_blank">EDSM Oldest Stations</a> and <a href="eddb.php">EDDB</a> closest missing offers nothing but endless list of planetary bases or outposts, where I would never trade with a lakon type-9.
</p>
...
Launched EDMC and of course had long list of upgrades coming.
	...
	<h2>2019-09-08 Hunt For The Missing Data</h2>
...
<p>
Perhaps I'm confusing that to normal exploration traveling which is one system in 44 seconds, while visiting stations for <a href="eddn.php">EDDN</a> sending is more like 14 minutes per station, as strange as that sounds. It really depends, for example distance from star is what mostly dictates how long one station takes, planetary usually takes more time than outpost in space, but if you have close ones with basically no traveling time, then it can be as quick as 5min or so.
</p>

<p>
Also good to note about yesterdays "depressed" mood is that I recall there being 20,000 stations in populated space, so there can be thousands of these missing data stations and my 37 visits per day... don't even make a dent on the list after a week <img src="images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
Edit: took a look at <a href="https://eddb.io/station" target="_blank">eddb.io/station</a> list and it says: Found <b>68,985 stations</b>. oh man that is huge number of stations and here I was thinking it was 20k hehe. Wow just imagine how many stations there are to do if even 10% of them are missing data... whoah! <img src="images/smileys/icon_surprised.gif" alt="Smiley :o" loading="lazy">
</p>
...
<p>
I'm thinking of departing to long exploration journey or to go mining, perhaps even trading using eddb (because latest <a href="tradedangerous.php">TradeDangerous</a> is not working)... but all this feels like desperate attempt to get something interesting going on which is impossible while you're bored. Dunno, just dunno man...
</p>
...
<p>
2019-09-11T02:37:40Z arrived at Wat Yu system and docked to Cameron Gateway, no interdictions, not even a one threat on the radio comms! amazing! <img src="images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
Sold the palladium for hundred and seventy thousand something and all this painite mining gave me 514,423,750cr! Budget now 4.302 billion <img src="images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
2019-09-11T13:35:27Z new day has started, back at elite, docked in Jameson Memorial.
	...
	<h2>Trading With Lakon Type-9</h2>

<p>
Took out PMC Trader which is my good old Lakon Type-9, sold the supercruise assist whatever newbie module and purchased massive 2t cargo rack, now my total capacity is 790t <img src="images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
2019-09-11T14:38:54Z docked at Kingsmill Hub and sold 790x military grade fabrics for 6.357 million profit! <img src="images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
After some time tinkering with TradeDangerous I decided to go EDDN send market data for the "olddata" systems and see if those gets updated nearly in real time.
	...
	<h2>2019-09-11 Hunt For The Missing Data</h2>
...
<p>
2019-09-12T16:14:02Z new day has started, back in Elite and time to... well trade, mine or EDDN send missing data, dunno exactly what I'm going to do today, maybe everything <img src="images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
2019-09-12T20:18:29Z docked at BD-04 2421/Phillips Ring which concludes this list of TradeDangerous olddata list for now. I want to do something else, probably going back to mining.
	...
	<h2>2019-09-12 Painite Mining</h2>

<p>
2019-09-12T20:54:30Z docked at Jameson Memorial, time to break out PMC Miner 2 and outfit it a bit better. Used this outfitting: <a href="https://edsy.org/#/L=FY00000H4C0S20,mpUJrO00Jpq00Jpq00,,9p310AAA10ARM00AfQ00Aty00B8g00BLe00BeE10,,0DI100DI100Bk105Vk007Sk005Sc000bg004zM005Sc005uk002jw00,pmc_0miner_02,SN_D10T" target="_blank">edsy.org PMC Miner 2 Specifications</a>.
</p>
...
<p>
2019-09-12T22:56:03Z got 147t painite in cargo, have to take a quick lunch break <img src="images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Man was I scared when jumping as looked like every damn jump is into low or at best medium security system, it was hilarious as there was NO high security systems <img src="images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
2019-09-13T04:46:01Z docked at Perktomen/Rominger Station with a HUGE sigh of relief <img src="images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
Sold 14x palladium for 221.7k profit. When doing that I got few more painite refined from the refinery bin hopper thing, now I have 634t of painite. Sold that for 858.5k per unit profit, so total of 544.3 MILLION profit <img src="images/smileys/icon_biggrin.gif" alt="Smiley :D" loading="lazy">
</p>
...
2019-09-13T04:55:39Z Elite Log session systems visited (FSD jumps): 72, planets smallest: 2366.82km, largest: 9387.22km, detail surface scans: 151
	...
	<h2>2019-09-13 Trading With Lakon Type-9</h2>
...
<p>
Current PMC Trader outfitting: <a href="https://edsy.org/#/L=FY00000H4C0S20,,,9p310AAe10ARq00AfQ00Aty00B9800BLe00BeE10,,0DI100DI100Bk100AA1008c10072100721005U1005U1003w1002M10,PMC_0Trader,pmc003" target="_blank">edsy.org PMC Trader Specifications</a>.
</p>
...
<p>
Was checking out my asp in edsy.org and noticed I could squeeze in a bit more jump range and speed with replacing 3B power plant to 3C. Jump range now 63.04ly <img src="images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
<a href="https://edsy.org/#/L=Fg00000H4C0S10,,,9p310A5o10AN800AdsG05G0040vGt6tYo8sxJGyHHAsO00B1K00BNC10Bcg10,,5220034a00mpW2jw10,PMC_0Explorer,pmc005" target="_blank">edsy.org PMC Explorer Specifications</a>
</p>
...
<p>
Guess the 63.04ly jump range in PMC Explorer ASP rulez <img src="images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Now its time to continue exploring <img src="images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

	<h2>2019-09-16</h2>

<p>
2019-09-16T23:28:00Z everything done and back in PMC Explorer ASP cockpit, lets explore <img src="images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
2019-09-17T19:53:04Z arrived at Sidgoe WI-X c28-0 system. Distance to Sol: 19,275.12 ly. Discovered by a CMDR.
	...
	<h2>2019-09-18 Elite Dangerous v3.5 September Update</h2>
...
<p>
<b>2019-09-18T19:03:07Z Elite Dangerous v3.5 September Update released!</b> Back in my PMC Explorer ASP cockpit, in Grie Eork RN-I c26-0 system, distance to Sol: 22,809.81 ly.
</p>
...
<p>
2019-09-19T00:12:53Z arrived at Bloo Dryoae XS-K c11-0 system Distance to Sol: 23,865.06 ly was another system completely discovered by a CMDR. Oh my, is this what 2019 exploration is all about, "everything" discovered? <img src="images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
Elite Log session systems visited (FSD jumps): 34, special planets water: 4, planets smallest: 385.385km, largest: 77464.3km, detail surface scans: 363
	...
	<h2>2019-09-20 New Highscore Smallest Landable Planet</h2>
...
<p>
<b>2019-09-20T07:06:02Z New highscore planet radius SMALLEST! 156.874</b> km AND new highscore *landable* planet radius SMALLEST! 156.874 km, Syroifooe JK-E c25-0 A 1 a.
</p>

<p>
2019-09-20T08:50:02Z Getting little exhausting to play again, time to call it a night even though its not even close to night for me. Was a pretty good exploring day today, found a new highscore planet so gotta be happy with that <img src="images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
2019-09-21T04:00:59Z back at elite, but decided to switch into CMDR "Snake Man PMC" second account for some populated space activities. However I got stuck in FSD "blue tunnel" so had to come back to CMDR "Snake Man" real account and exploring <img src="images/smileys/icon_rolleyes.gif" alt="Smiley :rolleyes:" loading="lazy">
</p>
...
<p>
2019-09-27T04:28:45Z arrived at Syroifua CW-E d11-0 system which system star was discovered by a CMDR, and the next system I jumped after that... haha, sigh <img src="images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
<p>
2019-09-27T08:35:29Z arrived at Byooe Thaa VP-G d10-31 system and was almost falling a sleep while playing, gotta take a couple of hour nap <img src="images/smileys/icon_sad.gif" alt="Smiley :(" loading="lazy">
</p>
...
2019-09-27T14:40:26Z arrived at Prua Dryou XN-I c26-10 system which was mere 4700ly from sol and discovered by two CMDRs, so decided to stop checking FSS and just travel as fast as possible. I actually forgot to stop FSS scanning in the 10k ly mark heh.
	...
	<h2>2019-09-27 The Hunt For The Missing Data</h2>
...
<p>
2019-09-27T15:58:33Z docked at shinrarta dezhra/jameson memorial, exploration trip is over. Time to start selling exploration data <img src="images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
EDMC had like 6440 messages to send into eddn <img src="images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
Credits before selling data 4.882b, after 5.335b so made 453 million credits <img src="images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Switched ship to PMC EDDN Sender, purchased guardian FSD booster H class, then switched to open play, plotted course to Morong/ParryPenalcolony and off to hunt missing data for stations <img src="images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<pre>
python3 trade.py olddata --limit 100 --min-age 800 --ly 200 --route --near Morong
Station                          DistLy Age/days      StnLs Pad Plt
...
2019-09-28T15:30:18Z Alright I'm done visiting these small stations and planetary outposts... now I want to mine or trade... so off to jameson memorial.
	...
	<h2>2019-09-28 Trading With Lakon Type-9</h2>
...
<p>
Wanted adder interdicted me... for like four fucking times, he just kept on coming after each time I submitted and then escaped to supercruise. He even jumped at the station when I was docking but obviously saw the security and bugged out. I don't recall ever seen so enthusiastic killer/pirate <img src="images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
2019-09-29T04:47:34Z new elite day has begun! Lets trade <img src="images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
Balance now 5.448 billion, so made so far 77 million.
	...
	<h2>2019-09-29 Quick Try At Bounty Hunting</h2>
...
<p>
Since I was in jameson memorial and had this planned for quite some time already, I went and <b>sold all my ships which had no use</b>. Years ago I bought all the ships at the time just to have them, but now I realize having ships "just because" is dumb, you always have to scroll through that very long ship list for no reason.
</p>
...
<p>
Time to cook some food and eat <img src="images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
2019-09-29T11:05:08Z Took out vulture, added few outfitting items to it and then took it out for a spin in nearby anarchy system. <a href="https://edsy.org/#/L=FN00000H4C0S10,FEP00FEP00,mpUDx600Dho00,9p310A7210AOE00AcI00Aqq00B7a00BLA00BZY10,,7Sk006D2004xo00,PMC_0Bounty_0Hunter,PMC008" target="_blank">edsy.org PMC Bounty Hunter Specifications</a>.
</p>
...
<p>
<a href="https://edsy.org/#/L=FN00000H4C0S80,FEE00FEE00,mpUDx630Dho30,9p310A7210AOE00AcI00Aqq00B7a00BLA00BZY10,,7Sk006D2404xo30,PMC_0Bounty_0Hunter,PMC008" target="_blank">PMC Bounty Hunter Vulture Specifications</a>.
</p>
...
2019-09-29T14:54:58Z Interdicted wanted imperial courier, which high waked out as I opened fire. I then set course to jameson memorial, time to go back to mining or trading where I can make real progress, bounty hunting is boring.
	...
	<h2>2019-09-29 Trading With Lakon Type-9</h2>
...
2019-09-30T09:45:49Z Yup, nothing came to mind, shut down elite... dunno what I'll be doing now...
	...
	<h2>2019-10-01 Mining Painite</h2>
...
<p>
Used <a href="http://edtools.ddns.net/miner" target="_blank">edtools.ddns.net/miner</a> website to check painite, I mean the mining spots don't change much (if at all?), decided go to HIP 73269 A1 ring A
</p>
...
<p>
2019-10-01T14:02:46Z All done, cargo hold is full, hopper is full and I'm all out of limpets, aayeah! <img src="images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
Tihtipihin/Thuot Hub sell price is 797,152 credits. Unfortunately that is 256ly and 31 jumps away, yeah I don't think I'm going there heh. Next highest selling is Kunti/Hughes Enterprise which is 182ly and 21 jumps away, its still a long way but that where I'm off to. Wish me luck <img src="images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>
...
<p>
2019-10-01T14:42:13Z Docked at Kunti/Hughes Enterprise with a huge sigh of relief! <img src="images/smileys/icon_smile.gif" alt="Smiley :)" loading="lazy">
</p>

<p>
Watch youtube video of this scary return trip: <a href="https://www.youtube.com/watch?v=mdu_Epx26hc" target="_blank">Return From Mining 640t of Painite 2019-10-01 Elite Dangerous</a>.
</p>
...
<p>
2019-10-05T17:24:56Z Getting too bored to visit stations, time to stop for now (going to play <a href="https://www.pmctactical.org/" target="_blank">ArmA 3</a> instead).
</p>
...
<p>
If you enjoyed this CMDR's log story, check out our others like: <a href="cmdr-snake-man-my-path-to-a-triple-elite.php">CMDR Snake Man My Path To A Triple Elite</a>, <a href="exploration-pmc-earth-like-world-tour.php">Exploration PMC Earth Like World Tour</a>, <a href="from-scratch-trading.php">From Scratch Trading (in open)</a>, <a href="my-path-to-anaconda.php">My Path To Anaconda</a> and <a href="pmc-galaxy-loop.php">PMC Galaxy Loop</a>.
</p>
