...
<p>
Shooting lasers to asteroid rocks or ice cubes to extract minerals, that's space mining.
</p>
...
<ul>
<li>detailed surface scanner so you can find the hotspots (you need it even after you have scanned rings)</li>
...
<li>fuel scoop (optional, see below)</li>
</ul>
...
<p>
Carriers buying directly from miners have various price ranges, you should know what the current highest paying station is at (see below) before choosing which carrier to sell to. It is pointless to write numbers into this page as these numbers most likely have changed after 24hrs, but lets just say that a <i>very rough</i> ballbark would be that miner should not sell LTDs with less than 1 million per ton.
</p>
...
<p>
Search for stations buying expensive mineral by using <a href="https://eddb.io/commodity/83">eddb commodity painite</a>, <a href="https://eddb.io/commodity/276">eddb commodity low temperature diamonds</a>, <a href="https://inara.cz/galaxy-commodity/144/">inara commodity low temeprature diamonds</a> or <a href="tradedangerous.php">TradeDangerous</a>:
</p>
